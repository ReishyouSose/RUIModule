namespace RUIModule.RUIElements
{
    public class BaseUIElement
    {
        ...
        public class ElementEvents
        {
            ...
            /// </summary>
            public event UIMouseEvent UnLeftClick;

            /// <summary>
            /// 右键点击UI的事件（鼠标不在UI内）（按下时触发）
            /// </summary>
            public event UIMouseEvent UnRightClick;

            /// <summary>
            /// 左键双击UI的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnLeftDoubleClick;

            /// <summary>
            /// 右键双击UI的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnRightDoubleClick;

            /// <summary>
            /// 鼠标左键按下的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnLeftDown;

            /// <summary>
            /// 鼠标左键抬起的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnLeftUp;

            /// <summary>
            /// 鼠标右键按下的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnRightDown;

            /// <summary>
            /// 鼠标右键抬起的事件（鼠标不在UI内）
            /// </summary>
            public event UIMouseEvent UnRightUp;
            ...
            public delegate bool PreUICalculation(BaseUIElement baseElement);
            public delegate void PostUICalculation(BaseUIElement baseElement);
            public event PreUICalculation PreCalculation;
            public event PostUICalculation PostCalculation;
            ...
            public void NonLeftClick(BaseUIElement element) => UnLeftClick?.Invoke(element);

            public void NonRightClick(BaseUIElement element) => UnRightClick?.Invoke(element);

            public void NonLeftDoubleClick(BaseUIElement element) => UnLeftDoubleClick?.Invoke(element);

            public void NonRightDoubleClick(BaseUIElement element) => UnRightDoubleClick?.Invoke(element);

            public void NonLeftDown(BaseUIElement element) => UnLeftDown?.Invoke(element);

            public void NonLeftUp(BaseUIElement element) => UnLeftUp?.Invoke(element);

            public void NonRightDown(BaseUIElement element) => UnRightDown?.Invoke(element);

            public void NonRightUp(BaseUIElement element) => UnRightUp?.Invoke(element);
            ...
            public bool? PreCalculate(BaseUIElement element) => PreCalculation?.Invoke(element);
            public void PostCalculate(BaseUIElement element) => PostCalculation?.Invoke(element);
        }
        ...
        /// 是否绘制UI碰撞箱，0是整框，1是内框
        /// </summary>
        public Color?[] DrawRec = new Color?[3];
        ...
        {
            if (Events.PreCalculate(this) != false)
            {
                float left, top;
        ...
        {
            if (overrideGetCanHitBox != null)
            {
                return overrideGetCanHitBox.Invoke();
            }
            else
            {
                if (ParentElement == null)
                ...
                {
                    return Rectangle.Intersect(HitBox(), ParentElement.GetCanHitBox());
                }
            }
        }
        ...
        public void SetPos(float x, float y, float Xpercent = 0, float Ypercent = 0, bool cal = true)
        {
